...
public class ThreadCliente extends Thread {
            ...
            try {
                ...
                switch (partesOpcion[0]) {
                    case "pedirCoordenadas":
                        ...
                        System.out.println("Se lee el turno actual de quien está jugando: " + turnoActual);
                        // Informar al usuario que ingrese la primera coordenada
    ...
    // Envía ambas coordenadas al servidor (mismo método existente):
    public synchronized void enviarPosicionCartas(int x1, int y1, int x2, int y2) throws IOException {
        ...
        // Enviar primera y segunda coordenada
        esperarEntradaCoordenada(x1, y1);
        esperarEntradaCoordenada(x2, y2);
    }

// Envía una única coordenada (método existente):
